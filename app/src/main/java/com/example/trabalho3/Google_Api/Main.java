package com.example.trabalho3.Google_Api;
...
public class Main extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCoordinates = (TextView) findViewById(R.id.Coordenadas);
        btnGetCoordinates = (Button) findViewById(R.id.btnGetCoordenadas);
        btnLocationUpdates = (Button) findViewById(R.id.btnStartCoordenadas);
